...
from .views import (
    ...
    PatchDetailView,RefDB,ReleaseProductImageListAPIView,AllReleaseProductImagesAPIView,update_product_security_description,PatchesByProductView,product_patch_completion_percentage
)
