    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(choices=[('alpine', 'Alpine Linux Base Image'), ('base_os', 'Base OS'), ('tomcat', 'Tomcat'), ('jdk', 'JDK'), ('otds', 'OTDS'), ('otiv', 'OTIV'), ('new_relic', 'New Relic')], default='alpine', max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('is_deleted', models.BooleanField(default=False)),
                ('product_images', models.ManyToManyField(blank=True, related_name='patches', to='product_app.image')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(related_name='patches_set', to='product_app.product'),
        ),
        migrations.AddField(
            model_name='image',
            name='product',
