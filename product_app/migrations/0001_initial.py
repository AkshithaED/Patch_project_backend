...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('cve_id', models.CharField(default='CVE-1234', max_length=255, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('is_deleted', models.BooleanField(default=False)),
                ('high_level_scope', models.ManyToManyField(blank=True, related_name='patches', to='product_app.highlevelscope')),
                ('third_party_jars', models.ManyToManyField(blank=True, related_name='patches', to='product_app.jar')),
            ],
        ),
        migrations.CreateModel(
